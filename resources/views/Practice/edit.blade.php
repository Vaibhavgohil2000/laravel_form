    ...
    <div class="crud">
        ...
        <div class="crud-body">
            ...
            <div class="form-group">
                ...
                <input type="text" value={{$Form_Model['name']}} name="name" id="name" class="form-control" required="">
            </div>
            <div class="form-group">
                <label for="exampleInputEmail">City</label>
                <input type="text" value={{$Form_Model['city']}} name="city" id="city" class="form-control" required=""> 
            </div>
            <div class="form-group">
